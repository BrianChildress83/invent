...
<html lang="en">
<head>
    <title>Code coverage report for gulp-watch/index.js</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        div.coverage-summary .yui3-datatable-sort-indicator {
            background: url("http://yui.yahooapis.com/3.6.0/build/datatable-sort/assets/skins/sam/sort-invent-sprite.png") no-repeat scroll 0 0 transparent;
        }
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">gulp-watch/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.03% <small>(98 / 101)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">88.52% <small>(54 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">gulp-watch/</a> &#187; index.js</div>
</div>
<div class="body">
...
152
153
154</td><td class="line-coverage"><span class="cline-any cline-yes">6</span>
...
&nbsp;
    duplex.gaze.on('all', function (event, filepath) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (!opts.silent) { <span class="cstat-no" title="statement not covered" >logEvent(event, filepath, opts); </span>}
        var glob = [ filepath ];
        if (opts.emit === 'all') {
            glob = glob.concat(opts.glob ? opts.glob : <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
...
&nbsp;
    function restoreProperties(file) {
        if (pathCache[file.path]) {
            ...
            file.base = opts.base || calculateBase(opts.glob, file) || <span class="branch-2 cbranch-no" title="branch not covered" >file.base;</span>
            memorizeProperties(file);
        }
    }
&nbsp;
    function memorizeProperties(file) {
        pathCache[file.path] = {
            base: file.base,
            cwd: file.cwd || <span class="branch-1 cbranch-no" title="branch not covered" >process.cwd()</span>
        };
    }
&nbsp;
    return duplex;
...
function calculateBase(globs, file) {
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof globs === 'string') { <span class="cstat-no" title="statement not covered" >globs = [ globs ]; </span>}
    for (var globIdx in globs) {
        <span class="missing-if-branch" title="else path not taken"" >E</span>if (globs.hasOwnProperty(globIdx)) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Apr 17 2014 19:00:14 GMT+0600 (YEKT)</div>
</div>
